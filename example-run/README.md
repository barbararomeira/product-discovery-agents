...
| `metrics.md` | What the system reports about itself: 5 calls, **2 h 44 min of real talk time** read for you — and at that rate, **17.6 working days a year** of customer conversation read for you. |
